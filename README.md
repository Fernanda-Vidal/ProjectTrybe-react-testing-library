...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-021-a-project-react-testing-library.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-021-a-project-react-testing-library`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-021-a-project-react-testing-library`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-021-a-project-react-testing-library`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-021-a-project-react-testing-library/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-021-a-project-react-testing-library/pulls) e confira que o seu _Pull Request_ está criado
